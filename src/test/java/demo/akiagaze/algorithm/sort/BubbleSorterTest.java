...
public class BubbleSorterTest {
  ...
  public void test_sort_an_int_array_with_direction_desc() {
    ...
    sorter.bubbleSort(array, BubbleSorter.Direction.DESC);
  ...
  public void test_sort_an_int_array_with_direction_asc() {
    ...
    sorter.bubbleSort(array, BubbleSorter.Direction.ASC);
  ...
  public void test_sort_for_collection_1() {
    ...
    sorter.bubbleSort(list, BubbleSorter.Direction.DESC);
